...
class acd_slmain:
    def __init__(self):
        ...
        arg.add_argument('--region', help='Amazon region (com, it, fr..)', default='com')
...
class acd_slmeta:
    ...
    def getCollections(self, region):
        ...
        return acd_collection('https://www.amazon.'+region+'/drive/v1/nodes/{}/children?resourceVersion=V2&ContentType=JSON&limit=200&sort=%5B%22kind+DESC%22%2C+%22modifiedDate+DESC%22%5D&asset=ALL&tempLink=true&shareId={}'.format(self.id, self.shareId), self.shareId)
...
class acd_collection:
    ...
    def getChildren(self, id, region):
        ...
        return acd_collection('https://www.amazon.'+region+'/drive/v1/nodes/{}/children?resourceVersion=V2&ContentType=JSON&limit=200&sort=%5B%22kind+DESC%22%2C+%22modifiedDate+DESC%22%5D&asset=ALL&tempLink=true&shareId={}'.format(id, self.shareId), self.shareId)
